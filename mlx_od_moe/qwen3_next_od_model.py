...
class Qwen3NextODMoEModel(nn.Module):
    ...
    def generate(
        ...
        for step in range(max_new_tokens):
            ...
            # Debug (cheap): compare incremental cached logits vs full
            # recompute ONLY for step 1. This isolates cache correctness without
            # blowing up runtime.
            ...
            if step == 0:
                try:
                    ...
                    print(f"[debug] step1 inc_vs_full failed: {_e}", flush=True)
            else:
                # keep growing full_ids for later steps
